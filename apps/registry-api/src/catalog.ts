...
export const SEED_SKILLS: RegistrySkill[] = [
  ...
  },
  {
    ...
    description:
      "Inventory public functions, flag stubs and untested symbols, and name the next skills that raise SWE quality for this change. Use after implement, before claiming done, or when asked to QA, find missing tests, or catch half-done functions.",
    version: "0.1.0",
    compatibility: ["claude-code", "grok-build", "codex"],
  },
  {
...
export const SEED_PACKS: RegistryPack[] = [
  ...
  },
  {
    ...
    extends: ["essentials"],
    skillCount: ESSENTIALS.length + 2,
    skills: [
      ...ESSENTIALS,
      "ship-checklist",
      "a11y-pass",
  ...
  },
  {
    ...
    extends: ["essentials"],
    skillCount: ESSENTIALS.length + 1,
  ...
  },
  {
    ...
    extends: ["essentials"],
    skillCount: ESSENTIALS.length + 3,
